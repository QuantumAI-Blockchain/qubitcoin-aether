...
class Config:
    ...
    AETHER_LONG_TERM_CONSOLIDATION_INTERVAL: int = int(os.getenv('AETHER_LONG_TERM_CONSOLIDATION_INTERVAL', '3300'))
    ...
    AETHER_AUTONOMOUS_REASONING_INTERVAL: int = int(os.getenv('AETHER_AUTONOMOUS_REASONING_INTERVAL', '10'))
