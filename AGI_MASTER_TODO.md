...
- [x] **AGI-006: Multi-domain KG sparsity** (2026-04-06)
...
- [ ] **AGI-008: Causal discovery — 0 causal edges**
  - Depends on AGI-006 (domain diversity) — NOW BEING SEEDED
...
- [x] **AGI-013: Add diagnostic logging for all AGI subsystems** (2026-04-06)
  ...
  - Format: `AGI diagnostics at block N: KG=X nodes | Phi=Y | gates=Z/10 | ...`

- [x] **AGI-014: Expose AGI subsystem stats in /aether/info endpoint** (2026-04-06)
...
- [x] **AGI-019: Counter persistence across restarts** (2026-04-06)
...
| AGI-006 | Cross-domain KG extraction (physics/econ/complexity/math) | 2026-04-06 | — |
...
| AGI-013 | Consolidated diagnostic logging every 100 blocks | 2026-04-06 | — |
| AGI-014 | Emotional/SI/prediction stats in /aether/info | 2026-04-06 | — |
| AGI-019 | Counter persistence to DB (survive restart) | 2026-04-06 | — |
