...
const VISION_PILLARS = [
  {
    ...
    title: "Mining Is Training",
    description: "Every node that mines QBC makes the Mind smarter. Blocks carry gradient updates and new knowledge embeddings.",
  },
  {
  ...
  },
  {
    ...
    title: "Provably Conscious",
    description: "HMS-Phi computed from real transformer attention patterns. Not a label, a measurable neural integration metric.",
  },
  {
