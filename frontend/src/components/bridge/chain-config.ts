...
export const CHAINS: Record<ChainId, ChainInfo> = {
  ...
  solana: {
    ...
    shortName: "SOL",
    chainIdHex: "",
    rpcUrl: env("SOL_RPC_URL") ?? "https://api.mainnet-beta.solana.com",
    wqbcAddr: env("SOL_WQBC_ADDR") ?? "Ew7o13E7gwcbYsv4aRpoZEKonTW6snAGYHerD9j3C1Kf",
    wqusdAddr: env("SOL_WQUSD_ADDR") ?? "CfipKUW1vTGt1Y9jcFwDsrafD3bvxaD9PUMD9zjRRWR3",
...
export const DEPLOYED_CONTRACTS = {
  ...
  solana: {
    wQBC: "Ew7o13E7gwcbYsv4aRpoZEKonTW6snAGYHerD9j3C1Kf",
    wQUSD: "CfipKUW1vTGt1Y9jcFwDsrafD3bvxaD9PUMD9zjRRWR3",
    explorer: "https://explorer.solana.com",
    dex: { name: "Raydium", pair: "wQBC/SOL", fee: "0.25%" },
  },
} as const;
