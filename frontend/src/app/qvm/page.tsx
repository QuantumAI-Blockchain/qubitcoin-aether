        ...
        <Card>
          ...
          <div className="space-y-4">
            <div>
              ...
              <select className="w-full rounded-lg bg-bg-deep px-4 py-2.5 text-sm text-text-primary focus:outline-none focus:ring-2 focus:ring-quantum-violet/50">
            ...
            <table className="w-full text-sm">
              ...
              <tbody className="font-[family-name:var(--font-code)]">
                {[
                  ...
                  <tr key={op.name} className="border-b border-border-subtle/50">
                    ...
                    <td className="py-2 font-[family-name:var(--font-reading)] text-text-secondary">
                      {op.desc}
                    </td>
                  </tr>
                ))}
